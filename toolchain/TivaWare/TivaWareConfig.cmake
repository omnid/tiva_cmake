if(NOT TivaWare_FOUND)
  ...
  if(CMAKE_SYSTEM_PROCESSOR MATCHES "TM4C123")
    target_compile_definitions(driverlib INTERFACE TARGET_IS_TM4C123_R${TM4C123_REVISION})
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "TM4C129")
    target_compile_definitions(driverlib INTERFACE TARGET_IS_TM4C129_R${TM4C129_REVISION})
  else()
