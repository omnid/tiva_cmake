...
By default, the project links against the release version of the startup code. 
If you would like to build against the debugging version of ~driverlib~ set ~DRIVERLIB_DEBUG=ON~.
* Development Tools
