...
You can use ~tiva-cmake~ as a [[*Template Mode (No Installation)][template]] or [[*Installation][install]] it and use it as a dependency. 
...
4. The ~PKGBUILD~ used to create the package is in the ~tiva-cmake~ directory
