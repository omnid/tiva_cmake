...
Use ~tiva-cmake~ as a [[*Template Mode (No Installation)][template]] or [[*Installation][install]] it and use it as a dependency.
...
however, installing it is one way to obtain the necessary development tools. It also includes a version of TivaWare's driverlib.

* Template Mode (No Installation)
Make sure you have the necessary [[*Dependencies][Dependencies]] installed. 
