...
You can use ~tiva-cmake~ as a [[*Template Mode (No Installation)][template]] or you can [[*Installation][install]] it.

When using ~tiva-cmake~ you must manually install the [[*Development Tools][Development Tools]], whereas the dependencies are automatically installed
