...
///  The TI-CGT C library provides this for us.
///  tiva-cmake provides a version for gcc
/// against a custom version
...
__attribute__((weak)) void ResetISR(void)
{
    unsigned int *pui32Src  = &__data_load__;
    unsigned int *pui32Dest = &__data_start__;
    ...
    __asm__ volatile ("    ldr     r0, =__bss_start__\n"
          "    ldr     r1, =__bss_end__\n"
          "    mov     r2, #0\n"
          "    .thumb_func\n"
          "zero_loop:\n"
...
#endif // END COMPILER SPECIFIC CODE
