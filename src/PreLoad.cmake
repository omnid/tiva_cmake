...
if(NOT TivaCMAKE_FOUND)
  ...
  set(CMAKE_PREFIX_PATH "${CMAKE_CURRENT_LIST_DIR}/../lib/build/install/")
...
if(CMAKE_TOOLCHAIN_FILE)
  if((NOT (EXISTS ${CMAKE_TOOLCHAIN_FILE})) AND (NOT EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_TOOLCHAIN_FILE}))
    set(CMAKE_TOOLCHAIN_FILE "${TivaCMake_DIR}/${CMAKE_TOOLCHAIN_FILE}" CACHE FILEPATH "The toolchain file" FORCE)
  endif()
endif()

set(CMAKE_TOOLCHAIN_FILE "${TivaCMake_DIR}/${DEFAULT_TOOLCHAIN}" CACHE FILEPATH "The default toolchain file")
